...
public class MainActivity extends Activity {
    ...
    public void printViewHierarchy(View parent, int level, int childidx){
        ...
        parent.getLocationOnScreen(positions);

        Log.d(TAG,levelStr + " " + parent.getClass().getName() + " child " + childidx + " (" + positions[0] +", "+ positions[1] + "), (" + parent.getWidth() + ", " + parent.getHeight() + ") " );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View myEditText = (View) findViewById(R.id.MYEDITTEXT1);
        myEditText.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                Log.d(TAG,"setOnKeyListener.onKey" + keyCode + " " + getKeyStatus(event));
                return false;
            }
        });
